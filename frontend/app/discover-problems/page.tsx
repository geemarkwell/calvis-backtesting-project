...
const DIAGNOSE_PROGRESS_LENSES = [
  ...
  { id: "policy-uniform-attire", name: "Policy 2", description: "Uniform and attire" },
  { id: "policy-time-scheduling", name: "Policy 3", description: "Time and scheduling" },
  { id: "policy-checkin-checkout", name: "Policy 4", description: "Check-in and check-out" },
  { id: "policy-patrol-expectations", name: "Policy 5", description: "Patrol expectations" },
  { id: "policy-escalation-rules", name: "Policy 7", description: "Escalation rules" },
];
