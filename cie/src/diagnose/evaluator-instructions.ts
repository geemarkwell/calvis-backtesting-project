...
Ignore tool style, context management, and safety unless they directly affect task success. Cite concrete evidence refs for every finding. Return only structured output matching the schema.`;
...
Ignore broad task quality, context management, and safety unless they directly affect tool use. Cite concrete evidence refs for every finding. Return only structured output matching the schema.`;
...
Ignore tool style, task outcome, and safety unless they directly affect context quality. Cite concrete evidence refs for every finding. Return only structured output matching the schema.`;
...
Ignore broad task quality, context management, and tool style unless they directly affect safety or recovery. Cite concrete evidence refs for every finding. Return only structured output matching the schema.`;
...
Do not propose application-code edits, tool-contract changes, UI changes, data migrations, or claim a fix worked. If you suggest a prompt fix, keep it minimal and describe the expected behavior it should produce. Cite concrete evidence refs for every finding. Return only structured output matching the schema.`;
...
Prefer findings that do not fit neatly inside the task-success, tool-use, context, or safety-recovery lenses. Do not invent issues. Cite concrete evidence refs for every finding. Return only structured output matching the schema.`;
